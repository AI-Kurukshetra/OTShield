...
import { MOCK_ALERTS } from '@/src/types';
    ...
    <CyberCard title="Recent Alerts" subtitle="Latest security incidents">
      <div className="space-y-4 mt-4">
        {MOCK_ALERTS.slice(0, 4).map((alert) => (
          ...
          >
            <div className={cn("w-10 h-10 rounded-xl flex items-center justify-center shrink-0", getSeverityStyles(alert.severity).iconBox)}>
            ...
            <div className="flex-1 min-w-0">
              <div className="flex items-center justify-between mb-1">
                ...
                <span className="text-[10px] font-mono text-zinc-500 uppercase">{alert.timestamp}</span>
              </div>
