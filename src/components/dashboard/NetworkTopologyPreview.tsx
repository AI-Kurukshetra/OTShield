      ...
      <div className="h-[350px] bg-brand-card/20 rounded-xl border border-brand-border/30 relative overflow-hidden mt-4 group">
          ...
          <div className="relative">
            ...
            {[0, 60, 120, 180, 240, 300].map((angle, i) => (
              ...
              >
                ...
                >
                  <div className={cn("w-1.5 h-1.5 rounded-full", i % 3 === 0 ? "bg-brand-danger" : "bg-brand-success")} />
                </div>
              </motion.div>
            ))}
            <svg className="absolute inset-0 w-full h-full pointer-events-none overflow-visible">
              <circle cx="0" cy="0" r="100" fill="none" stroke="rgba(0,240,255,0.1)" strokeWidth="1" className="translate-x-1/2 translate-y-1/2" />
              <circle cx="0" cy="0" r="140" fill="none" stroke="rgba(0,240,255,0.05)" strokeWidth="1" className="translate-x-1/2 translate-y-1/2" />
            </svg>
          </div>
        </div>
        <div className="absolute bottom-4 left-4 flex gap-4">
          <div className="flex items-center gap-2 px-3 py-1.5 rounded-lg bg-black/40 backdrop-blur-md border border-white/5">
            ...
            <span className="text-[10px] font-bold text-zinc-400 uppercase tracking-widest">Secure</span>
          </div>
          <div className="flex items-center gap-2 px-3 py-1.5 rounded-lg bg-black/40 backdrop-blur-md border border-white/5">
            <div className="w-2 h-2 rounded-full bg-brand-danger" />
            <span className="text-[10px] font-bold text-zinc-400 uppercase tracking-widest">Threat</span>
          </div>
        </div>
      </div>
    </CyberCard>
